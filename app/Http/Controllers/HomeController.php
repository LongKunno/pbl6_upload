...
class HomeController extends Controller
{
    ...
    public function postregister(Request $request)
    {
        ...
        # Send data
        $url = 'http://192.168.55.111:8080/api/auth/register';
        $data = array(
            'email' => $email,
            'username' => $username,
            'name' => $name,
    ...
    public function postforgotpassword(Request $request)
    {
        ...
        # Send data
        $url = 'http://192.168.55.111:8080/api/auth/forgot-password?username='.$username;
        $data = array(
            'username' => $username,
        );
        $options = array(
    ...
    {
        $api_url = 'http://192.168.55.111:8080/api/product/home/12';
    ...
    { 
        ...
        $api_url = 'http://192.168.55.111:8080/api/product/product/getByCategory';
    ...
    {
        $api_url = 'http://192.168.55.111:8080/api/product/detail/'.$url_id;
        $response = file_get_contents($api_url);
        $data = json_decode($response);
    ...
    public function buyding(Request $request,$id)
    {
        ...
        // $url = 'http://192.168.55.111:8080/api/carts/user/'.$user_id."/clean";
        ...
        $url = 'http://192.168.55.111:8080/api/carts/user/'.$user_id;
    ...
    public function deleteProduct($id)
    {
        ...
        $url = 'http://192.168.55.111:8080/api/carts/user/'.$user_id."?userId=".$user_id;
        $data = $this->send_data_access_token($postData,$url,"DELETE");
        return redirect()->route('giohang');
    }
    ...
    public function postComment(BinhluanRequest $request)
    {
        ...
        $url = 'http://192.168.55.111:8080/api/comment?rate='.$rate.'&userId='.$user_id.'&productId='.(int)$sanpham_id.'&content='.$binhluan_noi_dung;
        $data = $this->send_data_access_token($postData,$url,"POST");
