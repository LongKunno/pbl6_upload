...
@section('content')
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            <label>Tên</label>
            <input class="form-control" name="txtNCCName" placeholder="Nhập tên voucher..." value="{!! $data->voucher_ten !!}" />
            <div>
        ...
        <div class="form-group">
            ...
            <input class="form-control" name="txtNCCPhone" placeholder="Số điện thoại..." value="{!! $data->voucher_sdt !!}" />
            <div>
        ...
        <div class="form-group">
            <label>Địa chỉ</label>
            <textarea class="form-control" rows="2" name="txtNCCAdress" placeholder="Địa chỉ...">{!! $data->voucher_dia_chi !!}</textarea>
